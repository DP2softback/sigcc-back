# Generated by Django 3.1.3 on 2023-05-27 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ubicacion', models.CharField(choices=[('Auditorio primer piso', 'Auditorio primer piso'), ('Auditorio segundo piso', 'Auditorio segundo piso'), ('Auditorio tercer piso', 'Auditorio tercer piso'), ('Auditorio cuarto piso', 'Auditorio cuarto piso'), ('Auditorio quinto piso', 'Auditorio quinto piso')], max_length=30, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='capacitaciones.SesionXReponsable', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('Sin iniciar', 'Sin iniciar'), ('En progreso', 'En progreso'), ('Completado, sin evaluar', 'Completado, sin evaluar'), ('Completado, evaluado', 'Completado, evaluado'), ('Desaprobado', 'Desaprobado')], max_length=30)),
