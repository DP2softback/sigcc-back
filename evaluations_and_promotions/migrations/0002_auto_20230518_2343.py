...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='evaluated',
            field=models.ForeignKey(blank=True, db_column='evaluated_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employeeEvaluated', to='login.employee'),
        ),
        migrations.AddField(
            model_name='evaluation',
            name='evaluationType',
        ...
        migrations.AddField(
            model_name='evaluation',
            name='evaluator',
            field=models.ForeignKey(blank=True, db_column='evaluator_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employeeEvaluator', to='login.employee'),
        ),
        migrations.AddField(
            model_name='category',
            name='evaluationType',
